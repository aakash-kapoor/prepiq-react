    ...
    <div ref={containerRef} className="relative z-20 flex flex-col sm:flex-row sm:items-center gap-2 w-full sm:w-auto">
      ...
      <div className="relative min-w-[240px] sm:min-w-[280px] max-w-full">
        <button
          ...
          className="w-full flex items-center justify-between gap-3 px-4 py-2.5 bg-white border border-gray-200 hover:border-indigo-300 hover:bg-slate-50/50 rounded-xl text-left text-xs font-semibold text-slate-700 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
        >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-xl z-30 max-h-60 overflow-y-auto overflow-x-hidden p-1.5 focus:outline-none"
            >
